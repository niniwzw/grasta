...
VIDEOPATH = [video_path filesep 'test/'];
...
fg_color = zeros(450, 450, 3);
fg_color(:,:,1) = reshape(video_grasta_fg_R(:,90), 450, 450);
fg_color(:,:,2) = reshape(video_grasta_fg_G(:,90), 450, 450);
fg_color(:,:,3) = reshape(video_grasta_fg_B(:,90), 450, 450);
bg_color = zeros(450, 450, 3);
bg_color(:,:,1) = reshape(video_grasta_bg_R(:,90), 450, 450);
bg_color(:,:,2) = reshape(video_grasta_bg_G(:,90), 450, 450);
bg_color(:,:,3) = reshape(video_grasta_bg_B(:,90), 450, 450);
