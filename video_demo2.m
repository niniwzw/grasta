...
fg_color = zeros(128, 160, 3);
fg_color(:,:,1) = reshape(video_reprocs_fg_R(:,80), 128, 160);
fg_color(:,:,2) = reshape(video_reprocs_fg_G(:,80), 128, 160);
fg_color(:,:,3) = reshape(video_reprocs_fg_B(:,80), 128, 160);
bg_color = zeros(128, 160, 3);
bg_color(:,:,1) = reshape(video_reprocs_bg_R(:,80), 128, 160);
bg_color(:,:,2) = reshape(video_reprocs_bg_G(:,80), 128, 160);
bg_color(:,:,3) = reshape(video_reprocs_bg_B(:,80), 128, 160);
